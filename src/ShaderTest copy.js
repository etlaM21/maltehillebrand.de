...
const shaders = Shaders.create({
    ...
    vec2 shiftFrag(vec2 fragCoord, float shiftX, float shiftY){
        return vec2(fragCoord.x + shiftX, fragCoord.y + shiftY)/windowSize.x;
    }
    ...
    void main()
    {
        ...
        float size = windowSize.x / 250.0;
        vec2 mousePositionRelative = vec2(mousePos.x, mousePos.y) / windowSize.xy;
